...
//   address constant internal wethAddr = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
     address constant internal wethAddr = 0xc778417E063141139Fce010982780140Aa0cD5Ab;    

  /**
   * @dev Return memory variable address
   */
//   MemoryInterface constant internal instaMemory = MemoryInterface(0x8a5419CfC711B2343c17a6ABf4B2bAFaBb06957F);
    MemoryInterface constant internal instaMemory = MemoryInterface(0x9ab2a5C8e7AB86B65369b61e04f5e3b0215C92A5);
  /**
   * @dev Return InstaDApp Mapping Addresses
   */
//   InstaMapping constant internal instaMapping = InstaMapping(0xe81F70Cc7C0D46e12d70efc60607F16bbD617E88);
     InstaMapping constant internal instaMapping = InstaMapping(0xC1718623Ca9a4c01E21B4bf46AE2f065600d2065);
  /**
...
abstract contract Helpers is DSMath, Basic {
    ...
    BorrowerOperationsLike internal constant borrowerOperations = BorrowerOperationsLike(0x7F74df5F10b95FaAE9eadD79637Ddf4889e23730);
    TroveManagerLike internal constant troveManager = TroveManagerLike(0xEAe908f8CD40aF6D318074713E5043E348200451);
    StabilityPoolLike internal constant stabilityPool = StabilityPoolLike(0xFd0dB2BA8BEaC72d45f12A76f40c345BBf5f6F8d);
    StakingLike internal constant staking = StakingLike(0x35D3293EA6dD210b8Ca25668ae266ca4C834Ea1b);
    CollateralSurplusLike internal constant collateralSurplus = CollateralSurplusLike(0xc161AF3741Cf39afe176582160727fcB2B082506);
    LqtyTokenLike internal constant lqtyToken = LqtyTokenLike(0xf8A1aA1c34970aCE24041ef038A442732d942b89);
    TokenInterface internal constant lusdToken = TokenInterface(0xaf844BBaD90fB27ae949376338F7c9DA1251acFf);
